...
* **Manually                
  **Enables you to select which versions of each image to restore. You can specify which versions to restore on the [next wizard page](/chapter1/step-3-choose-data-to-restore/bare-metal-restore/352-specify-the-restore-source.md).
